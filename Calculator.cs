...
namespace PostfixNotation
{
    public class Calculator
    {
        public Calculator()
        {
            operators = new List<string>(standart_operators); //массив строк операторов
        ...
        {            
            ...
            while (pos < input.Length)
            {
                ...
                {
                    if (Char.IsDigit(input[pos]))// для дробных чисел
                    {
                            ...
                            case "l":
                                {
                                    decimal a = Convert.ToDecimal(stack.Pop());
                                    decimal b = Convert.ToDecimal(stack.Pop());
                                    summ = Convert.ToDecimal(Math.Log(Convert.ToDouble(a), Convert.ToDouble(b)));
                                    break;
                                }
                        }
                    }
        ...
        {
            Calculator Anna = new Calculator();
            while (true) 
            {
                try
                {
                    Console.WriteLine(Anna.result(Console.ReadLine()));
                }
                catch (Exception e) { Console.WriteLine("krya!"); }
            }
